...
# verification 
            ...
            mail_subject='Please activation your email'
            ...
            messages.success(request, 'Thank you registrting with us . We have send you a Verification email to your email adres[{{request.GET.email}}] . please verify it')
